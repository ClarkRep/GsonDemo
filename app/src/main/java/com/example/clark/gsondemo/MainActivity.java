...
//                .setFieldNamingPolicy(FieldNamingPolicy.UPPER_CAMEL_CASE)//会把字段首字母大写,注:对于实体上使用了@SerializedName注解的不会生效
        ...
        Log.i("haha", "只转换用@Expose注解的属性，并且null值可以序列号转换：" + json);
        //将Json转换成Bean
        Student stu = gson.fromJson(json, Student.class);
        Log.i("haha", "Json转换成Bean：" + stu);
    }
    ...
    private void gsonTest4() {
        ...
        Log.i("haha", "原生的studentJsonStr串：" + studentJsonStr);//{"birthDay":"May 30, 2016 11:40:17","id":1,"name":"张三"}
        JsonPrimitive jsonPrimitive = new JsonPrimitive(studentJsonStr);
        Log.i("haha", "JsonPrimitive转换后的串：" + jsonPrimitive);//"{\"birthDay\":\"May 30, 2016 11:40:17\",\"id\":1,\"name\":\"张三\"}"
        Log.i("haha", "JsonPrimitive转换后的串toString：" + jsonPrimitive.toString());//"{\"birthDay\":\"May 30, 2016 11:40:17\",\"id\":1,\"name\":\"张三\"}"
        Log.i("haha", "JsonPrimitive转换后的串getAsString：" + jsonPrimitive.getAsString());//{"birthDay":"May 30, 2016 11:40:17","id":1,"name":"张三"}
    }
    ...
    private void gsonTest5() {
        ...
        Log.i("haha", "JsonObjectToJson:" + jsonObjectToJson);
        ...
        Log.i("haha", "JsonArrayToJson:" + jsonArrayToJson);
...
//        JsonReader jsonReader = gson.newJsonReader(value.charStream());
        ...
        try {
            Student student = gson.fromJson(jsonStr, Student.class);
            Log.i("haha", "自定义TypeAdapter方式解析jsonStr：" + student);
        } catch (Exception e) {
            Log.i("haha", "自定义TypeAdapter方式解析jsonStr异常打印：" + e.toString());
        }
